...
const BINDINGS: &[(&str, &str)] = &[
    ...
    ("Left/Right (Dashboard)", "Switch SoundCloud mode (Tracks / Likes / Reposts / Search), reloads"),
    ("Enter (Search, typing)", "Run search, then switch to browsing results"),
    ("Enter (elsewhere)", "Play selected track, or drill into a SoundCloud category"),
